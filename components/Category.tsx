export default function Category({ setSelectedTag, tag, selectedTag }) {
  ...
  return (
    <div
      ...
      } inline-flex items-center px-5 py-2.5 drop-shadow-lg uppercase bg-blue-700 text-offwhite-1 hover:shadow-xl rounded-xl cursor-pointer font-heading text-xl`}
    >
